...
export function ROICalculator() {
  ...
  // Calculations
  const weeklyHoursSaved = teamSize * hoursWasted * 0.6; // assume 60% efficiency improvement with Clarity
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-base text-muted-foreground max-w-xl mx-auto">
            See how much administrative overhead and engineering hours you save by swapping heavy legacy software for Clarity.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-12 items-center bg-card border border-border/80 rounded-2xl p-6 sm:p-8 shadow-xl">
          ...
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="font-semibold text-foreground">Admin/Meeting Hours Wasted Weekly</span>
                <span className="font-mono text-primary font-bold bg-primary/10 px-2.5 py-0.5 rounded text-xs">
                  {hoursWasted} hrs / dev
                </span>
              </div>
          ...
          <div className="md:col-span-5 bg-muted/30 border border-border/50 rounded-xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 bg-card border border-border/40 p-3.5 rounded-lg shadow-2xs">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-muted-foreground uppercase font-semibold">Weekly Hours Saved</p>
              ...
              <div className="flex items-center gap-3 bg-card border border-border/40 p-3.5 rounded-lg shadow-2xs">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-muted-foreground uppercase font-semibold">Monthly Dollar Savings</p>
              ...
              {/* Annual Net ROI */}
              <div className="flex items-center gap-3 bg-primary/10 border border-primary/20 p-3.5 rounded-lg shadow-2xs">
            ...
            <div className="text-center pt-2">
              ...
              >
                Claim your {teamSize}-dev workspace
              </Link>
              <p className="text-[9px] text-muted-foreground mt-2 leading-relaxed">
                Calculations assume a 60% reduction in meeting coordination overhead.
              </p>
            </div>
          </div>
        </div>
